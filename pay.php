<style><?php include('css/COD.css');
include('bootstrap/bootstrap.min.css');?></style>
<html>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="success.php"><input type="submit" class="btn btn-success btn-block" value="PAY NOW" required="" /></a>  
                            </div>
                        </div>
